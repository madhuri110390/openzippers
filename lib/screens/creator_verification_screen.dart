...
class CreatorVerificationScreen extends ConsumerStatefulWidget {
  final dynamic currentUser;

  const CreatorVerificationScreen({
    super.key,
    required this.currentUser,
  });

  @override
  ConsumerState<CreatorVerificationScreen> createState() =>
      _CreatorVerificationScreenState();
}



class _CreatorVerificationScreenState extends ConsumerState<CreatorVerificationScreen>{
File? _govIdFront;
File? _govIdBack;
File? _livePhoto;
...
InkWell(
  onTap: () async {
    ...
    final notifier =
    ref.read(
      emailVerificationProvider.notifier,
    );
...
borderRadius: BorderRadius.circular(20),
  ...
  child: ref.watch(emailVerificationProvider)
      ? const SizedBox(
    height: 16,
    width: 16,
...
try {
final viewModel =
ref.read(verificationViewModelProvider.notifier);

final message =
await viewModel.uploadVerification(
governmentIdFront: _govIdFront!,
governmentIdBack: _govIdBack!,
passportPhoto: _livePhoto!,
);
